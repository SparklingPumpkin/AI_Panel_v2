#pragma checksum "E:\Projects\Tools\AI_Panel_v2\AI_Panel_v2\Views\ListDetailsPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "4003420B78A80030BBC1855A0B58AFE25693FC4E0334E890ADA57985AA48EF36"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace AI_Panel_v2.Views
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
        ...
        private class ListDetailsPage_obj1_Bindings :
            ...
            IListDetailsPage_Bindings
        {
            private global::AI_Panel_v2.Views.ListDetailsPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = global::WinRT.CastExtensions.As<global::AI_Panel_v2.Views.ListDetailsPage>(newDataRoot);
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::AI_Panel_v2.Views.ListDetailsPage obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_ViewModel(global::AI_Panel_v2.ViewModels.ListDetailsViewModel obj, int phase)
            {
            ...
            private void Update_ViewModel_SampleItems(global::System.Collections.ObjectModel.ObservableCollection<global::AI_Panel_v2.Core.Models.SampleOrder> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_ViewModel_Selected(global::AI_Panel_v2.Core.Models.SampleOrder obj, int phase)
            {
            ...
            private void UpdateTwoWay_12_SelectedItem()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        ...
                        {
                            this.dataRoot.ViewModel.Selected = (global::AI_Panel_v2.Core.Models.SampleOrder)this.obj12.SelectedItem;
                        }
                    }
                }
            }
            ...
            private class ListDetailsPage_obj1_BindingsTracking
            {
                ...
                public void PropertyChanged_ViewModel(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        global::AI_Panel_v2.ViewModels.ListDetailsViewModel obj = sender as global::AI_Panel_v2.ViewModels.ListDetailsViewModel;
                ...
                private global::AI_Panel_v2.ViewModels.ListDetailsViewModel cache_ViewModel = null;
                public void UpdateChildListeners_ViewModel(global::AI_Panel_v2.ViewModels.ListDetailsViewModel obj)
                {
